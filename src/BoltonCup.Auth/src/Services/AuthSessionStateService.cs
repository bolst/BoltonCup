...
{
    AuthSessionContext _internalContext { get; set; } = new();
    ...
    public void Reset() => _navigation.NavigateWithReturnUrl("log-in-or-sign-up");

    class AuthSessionContext : IAuthSessionContext
    {
