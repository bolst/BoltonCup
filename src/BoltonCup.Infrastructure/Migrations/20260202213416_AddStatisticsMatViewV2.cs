...
{
    /// <inheritdoc />
    public partial class AddStatisticsMatViewV2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // add skater stat mat view
            migrationBuilder.Sql(@"CREATE MATERIALIZED VIEW core.mv_skater_game_stats AS
									SELECT
										gl.player_id,
										gl.goals,
										gl.assists,
            ...
            // add goalie stat mat view
            migrationBuilder.Sql(@"CREATE MATERIALIZED VIEW core.mv_goalie_game_stats AS
									SELECT
										gl.player_id,
										gl.goals_against,
										gl.shots_against,
