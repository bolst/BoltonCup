...
{
    public async Task<IPagedList<Team>> GetAllAsync(GetTeamsQuery query, CancellationToken cancellationToken = default) => await _context.Teams
            .AsNoTracking()
    ...
    public async Task<Team?> GetByIdAsync(int id, CancellationToken cancellationToken = default) => await _context.Teams
            .AsNoTracking()
            .Include(e => e.GeneralManagers)
            .Include(e => e.Tournament)
            .Include(e => e.GoalSongTrack)
