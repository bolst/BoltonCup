...
namespace BoltonCup.Persistence.Migrations
{
    ...
    [Migration("20260911131628_TagAccountsInsteadOfPlayers")]
    partial class TagAccountsInsteadOfPlayers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoltonCup.Core.GameWarmupTrack", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("TournamentMusicTrackId")
                        .HasColumnType("integer")
                        .HasColumnName("tournament_music_track_id");

                    b.HasKey("Id");

                    b.HasIndex("TournamentMusicTrackId");

                    b.HasIndex("GameId", "TournamentMusicTrackId")
                        .IsUnique();

                    b.ToTable("game_warmup_tracks", "core");
                });

            modelBuilder.Entity("BoltonCup.Core.GeneratedImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("generated_images", "core");
                });
            ...
            modelBuilder.Entity("BoltonCup.Core.Highlight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BoltonCup.Core.TagLabel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BoltonCup.Core.Team", b =>
                {
                    ...
                    b.Property<int?>("PenaltySongTrackId")
                        .HasColumnType("integer")
                        .HasColumnName("penalty_song_track_id");
            ...
            modelBuilder.Entity("BoltonCup.Core.TournamentMusicQueue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.PrimitiveCollection<List<int>>("Deck")
                        .IsRequired()
                        .HasColumnType("integer[]")
                        .HasColumnName("deck");

                    b.Property<int>("DeckCursor")
                        .HasColumnType("integer")
                        .HasColumnName("deck_cursor");
                    ...
                    b.PrimitiveCollection<List<int>>("Priority")
                        .IsRequired()
                        .HasColumnType("integer[]")
                    ...
                    b.ToTable("tournament_music_queues", "core");
                });
            ...
            modelBuilder.Entity("BoltonCup.Core.GameWarmupTrack", b =>
                {
                    b.HasOne("BoltonCup.Core.Game", "Game")
                        .WithMany("WarmupTracks")
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BoltonCup.Core.TournamentMusicTrack", "Track")
                        .WithMany()
                        .HasForeignKey("TournamentMusicTrackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("BoltonCup.Core.Team", b =>
                {
                    ...
                    b.HasOne("BoltonCup.Core.TournamentMusicTrack", "PenaltySongTrack")
                        .WithMany()
                        .HasForeignKey("PenaltySongTrackId")
                        .OnDelete(DeleteBehavior.SetNull);
