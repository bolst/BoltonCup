...
public class TeamService : ITeamService
{
    ...
    public async Task<IPagedList<Team>> GetAllAsync(GetTeamsQuery query, CancellationToken cancellationToken = default) => await _dbContext.Teams
            .AsNoTracking()
            .Include(e => e.GeneralManagers)
            .Include(e => e.Tournament)
            .Include(e => e.GoalSongTrack)
            .Include(e => e.WinSongTrack)
            .Include(e => e.PenaltySongTrack)
    ...
    public async Task<Team?> GetByIdAsync(int id, CancellationToken cancellationToken = default) => await _dbContext.Teams
            .AsNoTracking()
            .Include(e => e.GeneralManagers)
            .Include(e => e.Tournament)
            .Include(e => e.GoalSongTrack)
